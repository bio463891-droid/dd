...
function TeacherCard({ teacher }) {
  return (
    <TouchableOpacity style={styles.teacherCard} activeOpacity={0.85}>
      <Image
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={[styles.topBar, { paddingTop: insets.top + 8 }]}>
        ...
        <Image
          source={{ uri: 'https://via.placeholder.com/120x36/1A1F38/FFFFFF?text=LOGO' }}
          style={styles.logo}
          resizeMode="contain"
        />
